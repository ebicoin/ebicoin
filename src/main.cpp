...
// Copyright (c) 2018 The Ebicoin developers
...
#endif
{
    ...
    int64 nTargetSpacing = STAKE_TARGET_SPACING * 2; // ebicoin: both Proof-of-Work and Proof-of-Stake have equal probability of block generation
...
bool static LoadBlockIndexDB()
{
    ...
    BOOST_FOREACH(const PAIRTYPE(int, CBlockIndex*)& item, vSortedByHeight)
    {
        ...
        if (!CheckStakeModifierCheckpoints(pindex->nHeight, pindex->nStakeModifierChecksum))
            return error("LoadBlockIndexDB() : Failed stake modifier checkpoint height=%d, modifier=0x%016" PRI64x ", checksum=0x%08x", pindex->nHeight, pindex->nStakeModifier, pindex->nStakeModifierChecksum);
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x3addfa4ba6cef0d00499c3c8cc52e4a45fbc4e9d0a4e362b291565eb6d7dd8e6"));
