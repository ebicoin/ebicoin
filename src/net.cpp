...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ebicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedebicoin", "seed.ebicoin.org"},
    {"seed", "seed.ebicoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedebicoin", "tseed.ebicoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ebicoin is probably already running."), addrBind.ToString().c_str());
        else
