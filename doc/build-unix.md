...
UNIX BUILD NOTES FOR EBICOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/ebicoin/ebicoin
	cd ebicoin
...
This will build Ebicoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no ebicoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip ebicoind" to strip the debug
